...
* Português
* Español
* Turkish (thanks to [*ra.*](http://www.worldarchivetr.com/wp/hakkinda/)
...
* Bug fix: Unwanted modification got included in v1.2.1, probably related to [this report](http://wordpress.org/support/topic/light-theme-broken-since-121-update). 
